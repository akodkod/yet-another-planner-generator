    ...
    <ContextMenuPrimitive.SubContent
      ...
      className={cn(
        `
          ...
          z-50 min-w-[8rem] origin-(--radix-context-menu-content-transform-origin) overflow-hidden rounded-md border p-1
          shadow-lg
        `,
        className,
      )}
      ...
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          `
            ...
            origin-(--radix-context-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border
            p-1 shadow-md
          `,
          className,
        )}
